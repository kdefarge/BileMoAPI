 ...
 */
final class Version20210427001204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3C7323E0737452E1 ON mobile (model_name)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3C7323E0737452E1 ON mobile');
    }
}
